...
namespace Sekemin.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Osoba { UserName = Input.Email, Email = Input.Email, Grad = Input.Grad, Ime = Input.Ime, Prezime = Input.Prezime, DatumRodjenja = Input.DatumRodjenja, Spol = Input.Spol, Uloga = Input.Uloga};
